...
namespace ga {
template <typename T, std::size_t populationSize, std::size_t geneLength> class Population
{
    static_assert(populationSize > 0, "Population size cannot be negative or zero");
	...
	void RegisterChromosomeGenerator(std::function<void(Chromosome<T,geneLength> &)> f);
...
template<typename T, std::size_t populationSize,std::size_t geneLength>
Population<T,populationSize,geneLength>::Population(const Population<T,populationSize,geneLength> &population)
{
...
template<typename T, std::size_t populationSize,std::size_t geneLength>
Population<T,populationSize,geneLength> &Population<T,populationSize,geneLength>::operator=(
...
template<typename T, std::size_t populationSize,std::size_t geneLength>
void Population<T,populationSize,geneLength>::RegisterChromosomeGenerator(std::function<void(Chromosome<T,geneLength> &)> f)
{
...
{
    std::for_each(aChromosomePopulation.begin(),aChromosomePopulation.end(),fChromosomeGenerator);
}
}
